export const appToggles: {
  ...
  { name: 'chatRepliesHide', cssValue: '--hidereplies', display: 'block' },
  { name: 'chatThreeDots', cssValue: '--chatthreedots', display: 'block' },
...
export const storageSetValueSettingsData: (
  ...
  { name: 'chattopbarColor', cssValue: '--chattopbarcolor', value: '#18181b' },
  { name: 'changefont', cssValue: '--fontfamily', value: 'Helvetica' },
  { name: 'changeChatWidth', cssValue: '--chatwidth', value: '354px' },
  { name: 'hideChatProfilePictures', cssValue: '--pfpdisplay', value: 'block', secondValue: 'none',},
  { name: 'timestampCheck', cssValue: '--timestamps', value: 'none', secondValue: 'block', },
];
