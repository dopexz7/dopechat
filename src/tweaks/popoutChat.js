const addPopoutChat = () => {
  ...
  if (elements && popbtn === null) {
    ...
    popoutButton.addEventListener('click', () => {
      ...
      var setChatPopout = setInterval(() => {
        try {
          if (
            myWindow.document.querySelectorAll('[role="banner"]')[0] !==
              undefined &&
            myWindow.document.querySelectorAll('[role="main"]')[0] !==
              undefined &&
            myWindow.document.querySelectorAll('.jgljxmt5')[0] !== undefined &&
            myWindow.document.querySelectorAll(
              '.fop5sh7t.cgat1ltu.tv7at329.j83agx80.c4hnarmi.bp9cbjyn'
            )[0] !== undefined &&
            myWindow.document.querySelectorAll('.be9z9djy')[0] !== undefined &&
            myWindow.document.getElementsByClassName('popoutbutton')[0] !==
              undefined &&
            myWindow.document.querySelectorAll(
            ...
            myWindow.document.querySelectorAll('.jgljxmt5')[0].style.minHeight =
              '100vh';
            myWindow.document.querySelectorAll(
              '.fop5sh7t.cgat1ltu.tv7at329.j83agx80.c4hnarmi.bp9cbjyn'
            )[0].style.left = '1%';
            myWindow.document.querySelectorAll('.be9z9djy')[0].style.top = '0';
            myWindow.document.getElementsByClassName(
              'popoutbutton'
            )[0].style.display = 'none';
            myWindow.document.querySelectorAll(
              '.tw6a2znq.f10w8fjw.d1544ag0.pybr56ya.j83agx80.bp9cbjyn'
...
const addPopoutChatButton = () => {
  let popbutn = document.getElementById('popbtn');
  if (!popbutn) {
